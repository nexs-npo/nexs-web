...
| **Content Management** | AI Agents (Claude Code, Gemini CLI) | AIエージェント経由でのMDXファイル作成・編集 |
...
### Git管理 (AIエージェント経由)
以下の「静的・半静的」なコンテンツはGitリポジトリ内でMDX形式で管理される。
AIエージェント（Claude Code、Gemini CLIなど）を使って直接作成・編集する。
*   議案 (Resolutions)
*   補助資料 (Resolution Materials)
*   ナレッジ記事 (Knowledge)
*   活動日誌 (Journal)
*   お知らせ (Announcements)
*   ドキュメント (Documents)
